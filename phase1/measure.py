...
JUDGE_MODEL = os.environ.get("JUDGE_MODEL", "gemma3n:e4b")
...
def judge_mention(answer: str, firm: str, competitors: list) -> dict:
    ...
    payload = {"model": JUDGE_MODEL, "prompt": judge_prompt, "stream": False, "format": "json"}
    try:
...
def main():
    ...
    ap.add_argument("--firm", required=True, help="우리 로펌/변호사명")
